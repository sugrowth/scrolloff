package com.unscroll.shared.data.memory
...
import com.unscroll.shared.domain.model.InterceptSensitivity
...
class InMemoryInsightRepository : InsightRepository {
    private val insights = MutableStateFlow<List<com.unscroll.shared.domain.model.PatternInsight>>(emptyList())

    override fun observeInsights(): Flow<List<com.unscroll.shared.domain.model.PatternInsight>> = insights

    override suspend fun addInsight(insight: com.unscroll.shared.domain.model.PatternInsight) {
