...
import com.scrolloff.shared.domain.model.AppCategory
import com.scrolloff.shared.domain.model.InterceptContext
...
class EvaluateInterceptDecisionUseCaseTest {
    ...
    fun `notification triggered intercept returns peek action`() {
        ...
        assertTrue(decision.recommendedAction is com.scrolloff.shared.domain.model.InterceptAction.NotificationPeek)
    }
    ...
    fun `credits available recommends allow`() {
        ...
        val decision = useCase(context)
        assertTrue(decision.recommendedAction is com.scrolloff.shared.domain.model.InterceptAction.Allow)
    ...
    fun `no credits recommends focus`() {
        ...
        val decision = useCase(context)
        assertTrue(decision.recommendedAction is com.scrolloff.shared.domain.model.InterceptAction.PromptFocus)
    }
}
